...
func init() {
	addModuleFactory("git", func() types.Module {
		return NewGit()
	})
}
...
func NewGit() *Git {
	...
	paramValues["accept_hostkey"] = types.NewBoolValue(&module.Params.AcceptHostkey)
	paramValues["accept_newhostkey"] = types.NewBoolValue(&module.Params.AcceptNewhostkey)
	paramValues["archive"] = types.NewStringValue(&module.Params.Archive)
	paramValues["archive_prefix"] = types.NewStringValue(&module.Params.ArchivePrefix)
	paramValues["bare"] = types.NewBoolValue(&module.Params.Bare)
	paramValues["clone"] = types.NewBoolValue(&module.Params.Clone)
	...
	paramValues["refspec"] = types.NewStringValue(&module.Params.Refspec)
	paramValues["remote"] = types.NewStringValue(&module.Params.Remote)
	paramValues["repo"] = types.NewStringValue(&module.Params.Repo)
	paramValues["separate_git_dir"] = types.NewStringValue(&module.Params.SeparateGitDir)
	paramValues["single_branch"] = types.NewBoolValue(&module.Params.SingleBranch)
	paramValues["ssh_opts"] = types.NewStringValue(&module.Params.SshOpts)
	paramValues["track_submodules"] = types.NewBoolValue(&module.Params.TrackSubmodules)
	paramValues["umask"] = types.NewStringValue(&module.Params.Umask)
	paramValues["update"] = types.NewBoolValue(&module.Params.Update)
	paramValues["verify_commit"] = types.NewBoolValue(&module.Params.VerifyCommit)
	...
	resultValues["after"] = types.NewStringValue(&module.Result.After)
	resultValues["before"] = types.NewStringValue(&module.Result.Before)
	resultValues["git_dir_before"] = types.NewStringValue(&module.Result.GitDirBefore)
	resultValues["git_dir_now"] = types.NewStringValue(&module.Result.GitDirNow)
	resultValues["remote_url_changed"] = types.NewBoolValue(&module.Result.RemoteUrlChanged)
	resultValues["warnings"] = types.NewStringValue(&module.Result.Warnings)
