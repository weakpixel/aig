...
func init() {
	addModuleFactory("package", func() types.Module {
		return NewPackage()
	})
}
...
func (p *PackageParams) Names() []string {
	names := []string{}
...
func (p *PackageParams) Set(name string, value interface{}) error {
	v, ok := p.values[name]
	if !ok {
...
func (p *PackageParams) Get(name string) (interface{}, error) {
	v, ok := p.values[name]
	if !ok {
...
func (r *PackageResult) Names() []string {
	names := []string{}
...
func (r *PackageResult) Set(name string, value interface{}) error {
	v, ok := r.values[name]
	if !ok {
		return fmt.Errorf("no param with name %q", name)
	}
...
func (r *PackageResult) Get(name string) (interface{}, error) {
	v, ok := r.values[name]
	if !ok {
		return nil, fmt.Errorf("no param with name %q", name)
	}
...
func (m *Package) GetResult() types.Result {
	return &m.Result
}
...
func (m *Package) GetParams() types.Params {
	return &m.Params
}
